    ...
    <div class="content">
        <div id="left">
            <div id="leftNavContent" class="active">
                ...
                <ul class="sideMenu">
                    <li class="dot-border"><a href="about.php">About</a></li>
                    <li class="dot-border"><a href="academics.php">Academic</a></li>
                    <li class="dot-border"><a href="admissions.php">Admissions</a></li>
                    <li class="dot-border"><a href="rc.php">Research and Consultancy</a></li>
                    <li class="currentpage "><a href="students.php"><strong>Student Welfare</strong></a>
                        <ul class="level_2">
                            <li class="dot-border"><a href="pages/antiragging.php"> Anti-Ragging </a></li>
                            <li class="dot-border"><a href="events"> Events </a></li>
                            <li class="dot-border"><a href="clubsnassocs"> Clubs and Associations </a></li>
                            <li class="dot-border"><a href="facilitiesnservices"> Facilities and Services </a>
                            </li>

                    </li>
                    <li class="dot-border"><a href="orientation"> Orientation </a></li>
                    <li class="dot-border"><a href="circulars"> Circulars &amp; Forms </a></li>
                    <li class="dot-border"><a href="insurance_forms"> Insurance Details </a></li>
                    <li class="dot-border"><a href="studentcouncil"> Student Council </a></li>
                </ul>
                </li>
                <li class="dot-border"><a href="pd">Planning and Development</a></li>
                <li class="dot-border"><a href="righttoinfoact">Right to Information Act</a></li>
                <li class="dot-border"><a href="other">Other Links</a></li>
                <li class="dot-border"><a href="contact">Contact</a></li>
                </ul>
